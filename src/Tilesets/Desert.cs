...
public class BackgroundDesert(float x, float y) : SimpleBackgroundBase(x, y, "BG Sand", "Desert/sandbackground");
...
[EditorGroup("ADGM|Tiles|Sand")]
public class DesertTileset(float x, float y) : SimpleTilesetBase(x, y, "Sand", "Desert/sand");
